...
from store.views import ShopUpdateView, SignUpView, LogInView, ProductListView, ProductInfoView, BasketView, \
...
urlpatterns = [
    ...
    path('shop/status/', ShopStatusView.as_view(), name='shop_status'),
]
